            ...
            <div class="about-content">
                <div class="row mb-5">
                    ...
                    <div class="col-5 text-right">
                        ...
                        <p>خلق تجربة يومية أفضل </p>
                    </div>
                    <div class="col-5 pr-0">
                        <div class="h2">
                            Our Mission
                        </div>
                        <p>Create a better everyday experience </p>
                    </div>
                    <div class="col-1"></div>
                </div>
                <div class="row">
                    ...
                    <div class="col-5 text-right">
                        ...
                        <p>ابتكار حلول متنوعة لتعزيز تجربة </p>
                    </div>
                    <div class="col-4">
                        <div class="h2">
                            Vision
                        </div>
                        <p>Innovate various solutions to enhance experience</p>
                    </div>
                    <div class="col-2"></div>
                </div>
            </div>
