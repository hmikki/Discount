...
trait AhmedPanelTrait
{
    ...
    {
        $this->setup();
        App::setLocale(session('my_locale','ar'));
    ...
    public static function Columns($column, $object){
        switch ($column['type']){
            ...
            case 'image':
                ...
                break;
            case 'color':
                return view('AhmedPanel.base.columns.color',compact('column','object'));
                break;
            case 'url':
    ...
    public static function Fields($Field, $value,$lang){
        switch ($Field['type']){
            ...
            case 'images':
                ...
                break;
            case 'color':
                return view('AhmedPanel.base.fields.color',compact('Field','value','lang'));
                break;
            case 'email':
