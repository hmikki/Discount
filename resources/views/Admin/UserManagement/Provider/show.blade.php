                                ...
                                <div class="card-content table-responsive">
                                    <table class="table table-hover">
                                        ...
                                        <tr>
                                            ...
                                            <td style="border-top: none !important;"><a href="{{url('app_content/orders?provider_id='.$Object->getId())}}">{{\App\Models\Order::where('provider_id',$Object->getId())->count()}}</a></td>
                                        </tr>
                                        <tr>
                                            <th style="border-top: none !important;">{{__('crud.'.$lang.'.offers_count')}}</th>
                                            <td style="border-top: none !important;"><a href="{{url('app_content/orders?provider_id='.$Object->getId())}}">{{\App\Models\OrderOffers::where('provider_id',$Object->getId())->count()}}</a></td>
                                        </tr>
                                    </table>
                                </div>
                            </div>
