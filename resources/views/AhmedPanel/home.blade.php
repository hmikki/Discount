...
{{--            <div class="card card-stats" onclick="window.location='{{url('user_managements/technicals')}}'" style="cursor: pointer">--}}
{{--                <div class="card-header" data-background-color="orange">--}}
{{--                    <i class="material-icons">people_outline</i>--}}
{{--                </div>--}}
{{--                <div class="card-content">--}}
{{--                    <p class="category">{{__('admin.sidebar.technicals')}}</p>--}}
{{--                    <h3 class="title">{{\App\Models\User::where('type',\App\Helpers\Constant::USER_TYPE['Technical'])->count()}}</h3>--}}
{{--                </div>--}}
{{--            </div>--}}
{{--        </div>--}}
